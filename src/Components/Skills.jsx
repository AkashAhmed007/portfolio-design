...
import { SiMongodb, SiExpress, SiTailwindcss, SiPostman, SiMongoose } from 'react-icons/si'; 
function Skills() {
  const skills = [
    ...
    { name: 'TanStack Query', icon:<FaHtml5/>, level: 'Intermediate' },
    { name: 'Postman', icon: <SiPostman size={40} color="#FF6C37" />, level: 'Intermediate' },
    { name: 'Mongoose', icon: <SiMongoose size={40} color="#800" />, level: 'Basic' },
  ];
