  ...
  return (
    <div id="about" className="hero min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse rounded-md">
        <img
          src={img}
          className="lg:w-60 md:w-40 w-32 hover:transition transform rounded-full"
        />
        ...
        <div>
          ...
          <p className="text-gray-600 pb-4">
          I have completed my Bachelors degree in Computer Science and Engineering from World University of Bangladesh.
          </p>
          <Link
            to="contact"
            smooth={true}
            duration={500}
            className="relative rounded px-5 py-2.5 overflow-hidden group bg-green-500 hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300 cursor-pointer"
          >
